...
<Image src="/image/merkle-tree/merkle-tree-generate.svg" alt="マークルツリーのルートの生成図" width={724} height={632} />

<Image src="/image/merkle-tree/merkle-tree-regenerate.svg" alt="マークルツリーのルートの再生成" width={724} height={632} />
...
<Image src="/image/merkle-tree/merkle-tree-regenerate-error.svg" alt="メモしたルートと生成したルートが違う" width={724} height={632} />
...
<AlertCard  title="マークルツリーの用語" variant="pro">
	...
	<Image src="/image/merkle-tree/merkle-tree-terminology.svg" alt="マークルツリーの全体図" width={648} height={526} />
</AlertCard>
...
<Image src="/image/merkle-tree/abi-encode-packed-compare-group.svg" alt="abi.encodePackedを使う場合と使うわない場合の比較図" width={724} height={341} />
...
<Image src="/image/merkle-tree/keccak256-not-view.svg" alt="keccak256を使うと元のデータを調べることができない" width={724} height={250} />
...
<Image src="/image/merkle-tree/proof-and-leaf-are-required-to-recalculate-root.svg" alt="rootを再計算するにはProofとleafが必要" width={724} height={249} />
...
<AlertCard  title="有料販売の場合" variant="pro">
	価格をつけて販売する場合は以下のNFTPayableを参考にしてみてください。
</AlertCard>
...
export const nftFreeConfig = {
  address: "0xE77E2143263807eB84b84ea21eDdB3F076777c83",
  abi: NFT_FREE_ABI,
} as const;
```
...
もし参考になったという方がいましたら、ブクマかTwitterなどでシェアしていただけると嬉しいです。

また、NFTプロジェクトを立ち上げたいなどでブロックチェーンエンジニアをお探しでしたら<a href="https://twitter.com/orca48691">DM</a>か<a href="mailto:ryuji48691771@gmail.com">メール</a>していただければご相談に乗りますのでお気軽に送っていただければと思います！
